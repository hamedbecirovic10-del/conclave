...
import { CONFIG_FILE, DEFAULT_URL, roomForPath } from "../shared/project.js";
const BEGIN = "<!-- conclave:begin -->";
const END = "<!-- conclave:end -->";
export function instructionsBlock(room) {
    return `${BEGIN}
...
export function upsertBlock(path, block) {
    if (!existsSync(path)) {
...
export function installClaudeHooks(root) {
